#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Crea tutti gli utenti richiesti"""
import sys
import os
...
with app.app_context():
    ...
    for user_data in users_to_create:
        ...
        if existing:
            ...
            updated += 1
            print(f"🔄 Utente {user_data['username']} aggiornato")
        else:
            # Crea nuovo utente
            user = User(
    ...
    db.session.commit()
    print(f"\n✅ Completato: {created} creati, {updated} aggiornati")
    print(f"📊 Totale utenti: {User.query.count()}")
