...
│   └── [altri script utilità]
├── utils/                        # Utility e helper
├── docs/                         # Documentazione
│
├── templates/                    # Template HTML
├── static/                       # File statici
├── listini/                      # Listini prezzi (PDF/XLSX)
├── offerte_generate/             # Offerte generate
...
- `init_email_db.py` - Inizializzazione database email
